...
export default function NewDuty() {
    ...
    return (
        <main className="container relative flex flex-col gap-8 px-12 pt-16">
            <h1 className="text-4xl font-light text-center text-white font-sans">
                new duty
            </h1>
            ...
            <form action={newDuty} className="flex flex-col gap-4 mt-4">
                ...
                <button
                    type="submit"
                    className=" text-neutral-900 bg-[#45EDAD] font-sans font-regular text-2xl p-2 rounded-md mt-8"
                >
                    Save
                </button>
                <button
                    type="submit"
                    className=" text-neutral-900 bg-[#ed454d] font-sans font-regular text-2xl p-2 rounded-md mt-8"
                >
                    Cancel
                </button>
            </form>
